...
class _$BookTearOff {
  ...
  _Book call({required int id, required String name}) {
    return _Book(
      id: id,
      name: name,
    );
...
class _$_Book implements _Book {
  const _$_Book({required this.id, required this.name});
...
abstract class _Book implements Book {
  const factory _Book({required int id, required String name}) = _$_Book;
